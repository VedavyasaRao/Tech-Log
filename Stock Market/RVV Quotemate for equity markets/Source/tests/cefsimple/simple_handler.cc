...
void SimpleHandler::OnAfterCreated(CefRefPtr<CefBrowser> browser) {
  ...
  outputfile = command_line->GetSwitchValue("outputfile");
  if (outputfile.empty())
...
bool  SimpleHandler::OnBeforeDownload(CefRefPtr<CefBrowser> browser, CefRefPtr<CefDownloadItem> download_item,
...
{
    CEF_REQUIRE_UI_THREAD();
    std::ofstream ofs(outputfile, std::ios_base::app| std::ios_base::ate);
    ofs << url.ToString() << std::endl;
    return false;
}
